...
export class Sync {
	...
	constructor(API, watchedPlaylists) {
		const x = this.ws = new ReconnectingWebSocket(() => `wss://gew4-dealer.spotify.com/?access_token=${API.getToken()}`, [], {
			WebSocket,
			minUptime: 30000
		});
		...
		this.ws.addEventListener("close", (e) => {
			console.warn("Sync Connection was closed", e);
		});

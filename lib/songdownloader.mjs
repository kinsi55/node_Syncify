	...
	static async remux(songBytes, savePath, tags = {}, coverNum = 0, ffmpegArgs) {
		...
		const coverArgs = coverNum < 0 ? [] :
			savePath.toLowerCase().endsWith(".m4a") ? [
				...
				/*
					HOW IS IT THAT FFMPEG HAS A 5000 PAGE LONG DOCUMENTATION BUT GOD FORBID
					I WANT TO ATTACH A FILE THEN IT HAS TO BE ON DISK THERES NO ALTERNATIVE
				*/
				"-attach", `cover${coverNum}.jpg`,
